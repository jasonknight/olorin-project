...
def mock_kafka_producer():
    ...
    def capture_send(topic, value=None):
        ...
        future.get.return_value = MagicMock(
            topic=topic,
            partition=0,
            offset=len(producer.sent_messages)
        )
        return future
...
def mock_openai_client():
    ...
    def create_completion(**kwargs):
        ...
        response_text = kwargs.get('_test_response', 'This is a test response from the AI.')
...
@pytest.fixture
def isolated_consumer_env(temp_db_path, mock_kafka_consumer, mock_kafka_producer, mock_openai_client, mock_config):
    """
